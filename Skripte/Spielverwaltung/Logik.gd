...
func erstelleMuenze():
	...
	match zufall:
		0,1,2: 
			muenze = load("user://Szenen/Muenzen/goodCoin1.tscn")
			test1 = test1+1
			istrandom = true
		2,3,4: 
			muenze = load("user://Szenen/Muenzen/goodCoin2.tscn")
			test2 = test2+1
		5,6: 
			muenze = load("user://Szenen/Muenzen/badCoin1.tscn")
			test3 = test3+1
		7,8: 
			muenze = load("user://Szenen/Muenzen/badCoin2.tscn")
			test4 = test4+1
		9,10: 
			muenze = load("user://Szenen/Muenzen/randomCoin.tscn")
			test5 = test5+1
			istrandom = true
